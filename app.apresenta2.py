...
if opcao == "INICIO":
    ...
    st.markdown( """ <style> .stApp { background-image: url("https://superhiper.com.br/devlop/wp-content/uploads/2025/06/Boa-Supermercado_Paulinia-SP.png"); background-size: cover; background-position: center; background-repeat: no-repeat; } </style> """, unsafe_allow_html=True)
